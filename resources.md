...
- [GPP Java reference implementation repository](https://github.com/InteractiveAdvertisingBureau/iabtcf-java)

## Tools

- [IAB GPP encoder/decoder](https://iabgpp.com/)
- [TCF V2 encoder/decoder](https://iabtcf.com/)
- [TCF V1.1 decoder](https://acdn.origin.appnexus.net/cmp/docs/#/tools/vendor-cookie-decoder)
